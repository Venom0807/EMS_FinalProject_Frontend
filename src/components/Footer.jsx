        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <ul className="list-none flex flex-col gap-2 mb-10">
              <li><a className="text-gray-600 cursor-pointer hover:text-[#50c878]">Home</a></li>
              <li><a className="text-gray-600 cursor-pointer hover:text-[#50c878]">About</a></li>
              <li><a className="text-gray-600 cursor-pointer hover:text-[#50c878]">Contact</a></li>
              <li><a className="text-gray-600 cursor-pointer hover:text-[#50c878]">Team</a></li>
            </ul>
          </div>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <ul className="list-none flex justify-center gap-4 items-center mb-10">
              ...
              <li><a><img src={github} alt="GitHub" /></a></li>
            </ul>
          </div>
        </div>
      </div>
